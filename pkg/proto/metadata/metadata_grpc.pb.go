...
type MetadataClient interface {
	// Metadata возвращает все доступные бакеты
	ListBuckets(ctx context.Context, in *ListBucketsRequest, opts ...grpc.CallOption) (*ListBucketsResponse, error)
	// Metadata создает бакет
	CreateBucket(ctx context.Context, in *CreateBucketRequest, opts ...grpc.CallOption) (*CreateBucketResponse, error)
	// Metadata возвращает информацию о бакете
	...
	// Metadata возвращает информацию об объекте
...
const (
	NodeDiscovery_Heartbeat_FullMethodName = "/metadata.NodeDiscovery/Heartbeat"
)
...
func (c *nodeDiscoveryClient) Heartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, NodeDiscovery_Heartbeat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNodeDiscoveryServer) Heartbeat(context.Context, *HeartbeatRequest) (*emptypb.Empty, error) {
...
func RegisterNodeDiscoveryServer(s grpc.ServiceRegistrar, srv NodeDiscoveryServer) {
	// If the following call panics, it indicates UnimplementedNodeDiscoveryServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _NodeDiscovery_Heartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HeartbeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeDiscoveryServer).Heartbeat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeDiscovery_Heartbeat_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeDiscoveryServer).Heartbeat(ctx, req.(*HeartbeatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeDiscovery_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "metadata.NodeDiscovery",
	HandlerType: (*NodeDiscoveryServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Heartbeat",
			Handler:    _NodeDiscovery_Heartbeat_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/proto/metadata/metadata.proto",
